...
Es wird keine zusätzliche Hardware benötigt. Der Unterschied zum normalen 14bit-Player
besteht darin, das die Cyber-Sound-Kalibrierung verwendet wird. Dadurch ist eine
weitere Qualitätssteigerung möglich. Das Cybersound-Kallibierungs-Programm befindet
sich z.B. :<br>
Aminet:disk/cdrom/14CDPlayer.lha<br>
Aminet:mus/play/play16.lha<br>
Die maximale Abspielrate beträgt auf PAL/NTSC-Bildschirmen ca. 29Khz und auf
