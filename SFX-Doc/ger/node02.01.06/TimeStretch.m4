...
__SECTION_STYLE_BEG
	...
	<tr bgcolor=__COL_SEC_BACK><td>
		<table border="0" width="100%" cellpadding="5" cellspacing="0"><tr><td>
<table border="0" cellspacing="1" cellpadding="2" width="100%"><tr bgcolor=__COL_TBL_ROW1><td align="right" valign="top"><nobr>TimeStretch Factor (<a href="../node03.02.01.html">P1</a>)</nobr></td><td align="left">Faktor für die Längenänderung
</td></tr>
<tr bgcolor=__COL_TBL_ROW2><td align="right" valign="top"><nobr>Window</nobr></td><td align="left">Fensterbereich; gute Ergebnisse erhält man mit Werten von 5 bis 100 ms
</td></tr>
<tr bgcolor=__COL_TBL_ROW1><td align="right" valign="top"><nobr>Smooth</nobr></td><td align="left">Über wieviel Prozent des Fensterbereiches übergeblendet werden soll;
