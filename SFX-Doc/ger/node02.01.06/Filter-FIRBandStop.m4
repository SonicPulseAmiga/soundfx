divert(-1)
define(`__TITLE',`Filter-FIRBandStop')
...
__SECTION_LABEL
__SECTION_STYLE_BEG
	__SECTION_HEADER(Filter-FIRBandStop)
...
<tr bgcolor=__COL_TBL_ROW2><td align="right" valign="top"><nobr>Low Cut-Off (<a href="../node03.02.01.html">P2</a>)</nobr></td><td align="left">untere Schranke des Bandes, relative Frequenz von 0 Hz bis zur halben Samplingrate
</td></tr>
<tr bgcolor=__COL_TBL_ROW1><td align="right" valign="top"><nobr>High Cut-Off (<a href="../node03.02.01.html">P3</a>)</nobr></td><td align="left">obere Schranke des Bandes
</td></tr>
<tr bgcolor=__COL_TBL_ROW2><td align="right" valign="top"><nobr>Nr. (Length)</nobr></td><td align="left">Wieviele Koeffizienten benutzt werden sollen. Je mehr Koeffizienten benutzt werden,
