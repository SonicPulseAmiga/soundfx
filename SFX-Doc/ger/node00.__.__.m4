divert(-1)
define(`__TITLE',`Einf&uuml;hrung')
		...
		__SECTION_STYLE_BEG
			...
			<tr bgcolor=__COL_SEC_BACK><td>
				<table border="0" cellpadding="5" cellspacing="0"><tr><td>
					<p align="justify">Nachfolgend gibt es erst einmal einen kleinen &Uuml;berblick &uuml;ber __SFX,
					gefolgt vom rechtlichen 'bla-bla' und - ganz wichtig - den Infos zum Registrieren nebst Kontaktangaben
					zum Autor [das bin ich ;-)].
					</p>
				</td></tr></table>
			</td></tr>
		__SECTION_STYLE_END
