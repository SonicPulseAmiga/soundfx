		...
		__SECTION_STYLE_BEG
			...
			<tr bgcolor=__COL_SEC_BACK><td>
				<table border="0" cellpadding="5" cellspacing="0"><tr><td>
					<p align="justify">__SFX ist ein Editor für digitalisierte Audiodaten (Samples).
					__SFX ist modular aufgebaut und besitzt eine komfortable grafische Benutzeroberfläche.
					...
					Folgend nun eine Übersicht der Features des Programms :<ul>
						<li>mehr als 65 <a href="node02.01.__.html">Operatoren</a> mit vielen Parametern und Modulationsmöglichkeiten wie z.B.:<ul>
						...
						<li>interne Signalauflösung von 80/16 bit<ul>
							<li>80 bit Fließkomma während der Effektberechnung</li>
						...
						<li>gute <a href="node02.03.__.html">Playroutinen</a><ul>
							...
							<li>Player spielen Samples direkt aus dem Fastram oder von HD ab und verbrauchen max 16 kByte Chipram während des Abspielens</li></ul></li>
						...
						<li>Operatoren sind nicht-destruktiv, d.h. das Ausgangssample wird nicht überschrieben oder gelöscht</li>
						...
						<li><a href="node03.__.__.html">ARexx-Port</a><ul>
							...
							<li>ARexx-Scripts können direkt von __SFX aus gestartet werden</li></ul></li>
						<li>systemkonforme grafische Oberfläche</li>
						...
						<li>Unterstützung AMIGA-spezifischer Funktionen<ul>
							<li>Dateiformatinformationen in Filenotes</li>
							<li>Erzeugung von Projekt-Piktogrammen</li>
							<li>Applikation-Icon</li></ul></li>
					</ul>
					In der <a href="node00.04.__.html">unregistrierten Version</a> können Sie ihre Samples nicht abspeichern und den ARexx-Port nicht benutzen !
					</p>
				</td></tr></table>
			</td></tr>
		__SECTION_STYLE_END
