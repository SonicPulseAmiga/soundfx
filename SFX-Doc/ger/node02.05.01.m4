		...
		__SECTION_STYLE_BEG
			...
			<tr bgcolor=__COL_SEC_BACK><td>
				<table border="0" width="100%" cellpadding="5" cellspacing="0"><tr><td>
					...
					<br>
					<p align="justify">Hiermit kann eine zu bearbeitende Quelle ausgew&auml;hlt werden. Das Cylegadget hinter dem Namen der Quelle, ermöglicht
					die Auswahl des zu speichernden Bereiches. __SFX schlägt ihn automatisch den wahrscheinlich gewünschten Modus
