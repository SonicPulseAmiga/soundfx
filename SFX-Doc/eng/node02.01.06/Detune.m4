...
__SECTION_STYLE_BEG
	...
	<tr bgcolor=__COL_SEC_BACK><td>
		<table border="0" width="100%" cellpadding="5" cellspacing="0"><tr><td>
<table border="0" cellspacing="1" cellpadding="2" width="100%"><tr bgcolor=__COL_TBL_ROW1><td align="right" valign="top"><nobr>Factor (<a href="../node03.02.01.html">P1</a>)</nobr></td><td align="left">Pitchfactor. A value of 2.0 means, your result is one octave higher (twice as high higher).
