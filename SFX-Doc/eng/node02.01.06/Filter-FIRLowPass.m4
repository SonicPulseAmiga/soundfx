divert(-1)
define(`__TITLE',`Filter-FIRLowPass')
...
__SECTION_LABEL
__SECTION_STYLE_BEG
	__SECTION_HEADER(Filter-FIRLowPass)
...
<tr bgcolor=__COL_TBL_ROW2><td align="right" valign="top"><nobr>Cut-Off (<a href="../node03.02.01.html">P2</a>)</nobr></td><td align="left">all frequencies above are getting processed, relative frequency ranging from 0 Hz to half of sampling-rate
</td></tr>
