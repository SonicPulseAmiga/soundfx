...
__SECTION_STYLE_BEG
	...
	<tr bgcolor=__COL_SEC_BACK><td>
		<table border="0" width="100%" cellpadding="5" cellspacing="0"><tr><td>
<table border="0" cellspacing="1" cellpadding="2" width="100%"><tr bgcolor=__COL_TBL_ROW1><td align="right" valign="top"><nobr>TimeStretch Factor (<a href="../node03.02.01.html">P1</a>)</nobr></td><td align="left">factor for change of the length
</td></tr>
<tr bgcolor=__COL_TBL_ROW2><td align="right" valign="top"><nobr>Window</nobr></td><td align="left">windowrange; use values in the range of 5 to 100 ms for good results
</td></tr>
<tr bgcolor=__COL_TBL_ROW1><td align="right" valign="top"><nobr>Smooth</nobr></td><td align="left">how much percentage of the windowrange should used for crossfade;
