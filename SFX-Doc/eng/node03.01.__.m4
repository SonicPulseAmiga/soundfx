		...
		__SECTION_STYLE_BEG
			...
			<tr bgcolor=__COL_SEC_BACK><td>
				<table border="0" cellpadding="5" cellspacing="0"><tr><td>
					<p align="justify">
					Currently __SFX offers more than 100 ARexx functions.
					If you need more, just let <a href="node00.05.__.html">me</a> know.
					Below you can find an overview of all functions
					(please note that all function-names start with &quot;SFX_&quot;):
					</p>
				</td></tr></table>
			</td></tr>
		__SECTION_STYLE_END
