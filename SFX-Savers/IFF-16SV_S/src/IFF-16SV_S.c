/****h* IFF-16SV/IFF-16SV_S.c [4.3] *
*
*  NAME
*    IFF-16SV_S.c
*  COPYRIGHT
*    $VER: IFF-16SV_S.c 4.3 (17.10.03) © by Stefan Kost 1998-2003
*  FUNCTION
*    IFF-16SV saver for SoundFX
*  AUTHOR
...
/****u* _savers/IFF-16SV_S *
*  Function.eng
*    Saves IFF-16SV Samples.
...
char *FormLabels[]={STR_PCM16,STR_FDPCM16_6,STR_EDPCM16_5,0l};
...
UBYTE __saveds __asm LIBSFXMod_Process(REG(a0,struct Instance *instance),REG(a1,ProcessData *pdata)) {
	...
	switch(instance->format) {
		case FORMAT_16SV_PCM16:		bufl=GetCrunchedLength(CRUNCH_PCM16    ,bufl);v8h.sCompression=COMP16SV_PCM;	break;
		case FORMAT_16SV_FDPCM16_6:	bufl=GetCrunchedLength(CRUNCH_FDPCM16_6,bufl);v8h.sCompression=COMP16SV_FDPCM;	break;
		case FORMAT_16SV_EDPCM16_5:	bufl=GetCrunchedLength(CRUNCH_EDPCM16_5,bufl);v8h.sCompression=COMP16SV_EDPCM;	break;
	}
	bufl*=(si->channels+1);
	size+=(bufl+8L);										/* BODY */
...
void LoadSettings(struct Instance *instance,char *fname) {
	...
	instance->format	=CfgIO_MatchString(
					 CfgIO_ReadString			(cfg,"General"	,"Format"		,FormLabels[FORMAT_16SV_PCM16]),FormLabels);
}
...
void SetDefaultSettings(struct Instance *instance) {
	...
	instance->format=FORMAT_16SV_PCM16;
}
