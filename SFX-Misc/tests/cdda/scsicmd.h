/****h* cdda/scsicmd.h [1.00] *
*
*  NAME
*    scsicmd.h
*  COPYRIGHT
*    $VER: scsicmd.h 1.00 (20.06.99) © by Stefan Kost 1999-11999
*  FUNCTION
*
*  AUTHOR
...
*    20.Jun.1999	V 1.00	most recent version
...
ULONG __inline SCSIStatus(struct SCSICmd *scsi_cmd) { return((ULONG)(((scsi_cmd->scsi_Status)&0x3E)>>1)); }
...
//-- scsi commands & answers

void __inline SCSICmd_6(UBYTE *cmd,UBYTE commandCode,UBYTE lun,UWORD pageCode,UBYTE length,UBYTE control)
{
	cmd[0]=commandCode;
	cmd[1]=lun<<5;
...
void __inline SCSICmd_10(UBYTE *cmd,UBYTE commandCode,UBYTE lun,ULONG pageCode,UWORD length,UBYTE control)
{
	cmd[0]=commandCode;
	cmd[1]=lun<<5;
...
void __inline SCSICmd_12(UBYTE *cmd,UBYTE commandCode,UBYTE lun,ULONG pageCode,ULONG length,UBYTE control)
{
	cmd[ 0]=commandCode;
	cmd[ 1]=lun<<5;
	cmd[ 2]=(UBYTE)((pageCode&0xFF000000)>>24);
