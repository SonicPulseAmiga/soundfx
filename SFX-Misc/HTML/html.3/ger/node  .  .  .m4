...
<html>
	...
	<body __PAGE_STYLE>
		__NAVBAR
		<!-- Logo -->
		<center><img src="../_img/logo.png" width="320" height="201"></center>
		<br>
		<!-- Contents -->
		<a name="#001">
		<table border="1" width="100%" cellpadding="2" cellspacing="0">
			...
			<tr bgcolor="#001177"><td>
				<table border="0" cellpadding="5" cellspacing="0"><tr><td>
					<p align="justify">Vielen Dank, da&szlig Sie sich f&uuml;r <b>SoundFX</b> entschieden haben (oder dies gerade tun).
					<b>SoundFX</b> ist ein umfangreiches und auch recht komplexes Programm. Deshalb ist es sehr wichtig die Dokumentation
