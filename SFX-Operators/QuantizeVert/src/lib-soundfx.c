/****h* QuantizeVert/lib-soundfx.c [4.2] *
*
*  NAME
*    lib-soundfx.c
*  COPYRIGHT
...
*  FUNCTION
*    QuantizeVert Operator module for SoundFX
*  AUTHOR
...
UBYTE SAVEDS ASM LIBSFXMod_Process(REG(a0,struct Instance *instance),REG(a1,ProcessData *pdata)) {
	...
	instance->divs=atof(param);
	UC_ConvertParameter(param,instance->mod2.vale,UGRP_AMPLITUDE,AMP_LEVEL);
	instance->dive=atof(param);
	instance->divd=instance->dive-instance->divs;
...
void SetDefaultSettings(struct Instance *instance) {
	...
	UC_ConvertParameter(instance->mod2.vals,"0.5",UGRP_AMPLITUDE,AMP_FC);
	UC_ConvertParameter(instance->mod2.vale,"0.5",UGRP_AMPLITUDE,AMP_FC);
