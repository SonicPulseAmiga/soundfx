/****h* QuantizeVert/QuantizeVert.h [4.2] *
*
*  NAME
*    QuantizeVert.h
*  COPYRIGHT
*    $VER: QuantizeVert.h 4.2 (06.03.03) © by Stefan Kost 1998-2003
*  FUNCTION
*    QuantizeVert core header file
*  AUTHOR
...
#ifndef  QUANTIZEVERT_H
#define  QUANTIZEVERT_H
