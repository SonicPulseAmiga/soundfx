/****h* QuantizeHoriz/QuantizeHoriz.h [4.2] *
*
*  NAME
*    QuantizeHoriz.h
*  COPYRIGHT
*    $VER: QuantizeHoriz.h 4.2 (06.03.03) © by Stefan Kost 1998-2003
*  FUNCTION
*    QuantizeHoriz core header file
*  AUTHOR
...
#ifndef  QUANTIZEHORIZ_H
#define  QUANTIZEHORIZ_H
...
#define SFXCoreInstanceFields \
	...
	Modulator				mod2;	/* Quantization Range */\
	\
	double					effs,effe,effd,eff,dry;\
	ULONG					lens,lene,lend,len;\
	\
	SAMPLE					*dbuf,*sbuf;
