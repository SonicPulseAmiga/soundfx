/****h* Gamma/lib-soundfx.c [4.2] *
*
*  NAME
*    lib-soundfx.c
*  COPYRIGHT
*    $VER: lib-soundfx.c 4.2 (06.03.03) © by Stefan Kost 1998-2003
*  FUNCTION
*    Gamma Operator module for SoundFX
*  AUTHOR
...
UBYTE SAVEDS ASM LIBSFXMod_Interface(REG(a0,struct Instance *instance)) {
	...
	if(g=CreateContext(&modGList)) {
		...
		if(g) {
			...
			DrawTitle(modrp,"Exponent"		,xs1,ys2,STDFRM_WIDTH);
...
UBYTE SAVEDS ASM LIBSFXMod_Process(REG(a0,struct Instance *instance),REG(a1,ProcessData *pdata)) {
	...
	instance->gammas=atof(param);
	UC_ConvertParameter(param,instance->mod.vale,UGRP_PROPOTION,PROP_FC);
	instance->gammae=atof(param);
	instance->gammad=instance->gammae-instance->gammas;
