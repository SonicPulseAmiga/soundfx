/****h* Filter-FIRHiPass/Filter-FIRHiPass.h [4.2] *
*
*  NAME
*    Filter-FIRHiPass.h
*  COPYRIGHT
*    $VER: Filter-FIRHiPass.h 4.2 (06.03.03) © by Stefan Kost 1998-2003
*  FUNCTION
*    Filter-FIRHiPass core header file
*  AUTHOR
...
#ifndef  FILTER_FIRHIPASS_H
#define  FILTER_FIRHIPASS_H
