/****h* Filter-FIRLowPass/Filter-FIRLowPass.c [4.2] *
*
*  NAME
*    Filter-FIRLowPass.c
*  COPYRIGHT
*    $VER: Filter-FIRLowPass.c 4.2 (11.03.03) © by Stefan Kost 1998-2003
*  FUNCTION
*    Filter-FIRLowPass core file
*  AUTHOR
...
*******
*/
/****u* _operators/Filter-FIRLowPass *
*  Function.eng
*    Works on high frequencies, means supresses or boosts them and let low frequencies pass through unaltered.
*  Funktion.ger
*    Bearbeitet hohe Frequenzen des Samples, d.h. unterdrückt oder verstärkt sie und läßt Tiefe durch.
*  Parameter.eng
...
*      all frequencies above are getting processed, relative frequency ranging from 0 Hz to half of sampling-rate
*    Nr. (Length)
...
*    Cut-Off (<a href="../node03.02.01.html">P2</a>)
*      alle darüberliegenden Frequenzen werden bearbeitet, relative Frequenz von 0 Hz bis zur halben Samplingrate
*    Nr. (Length)
