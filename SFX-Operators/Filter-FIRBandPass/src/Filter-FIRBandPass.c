/****h* Filter-FIRBandPass/Filter-FIRBandPass.c [4.2] *
*
*  NAME
*    Filter-FIRBandPass.c
*  COPYRIGHT
*    $VER: Filter-FIRBandPass.c 4.2 (11.03.03) © by Stefan Kost 1998-2003
*  FUNCTION
*    Filter-FIRBandPass core file
*  AUTHOR
...
*******
*/
/****u* _operators/Filter-FIRBandPass *
*  Function.eng
