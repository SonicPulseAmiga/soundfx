/****h* Panorama-2Ch/Panorama-2Ch.h [4.2] *
*
*  NAME
*    Panorama-2Ch.h
*  COPYRIGHT
*    $VER: Panorama-2Ch.h 4.2 (06.03.03) © by Stefan Kost 1998-2003
*  FUNCTION
*    Panorama-2Ch core header file
*  AUTHOR
...
#ifndef  PANORAMA_2CH_H
#define  PANORAMA_2CH_H
...
#define SFXCoreInstanceFields \
	...
	\
	Source					src;	/* Quelle */\
	Modulator				mod;	/* L-R Pos */\
	\
	double					lrs,lre,lrd,lr,rl;\
	\
