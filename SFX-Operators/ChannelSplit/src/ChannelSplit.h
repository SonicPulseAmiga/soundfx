/****h* ChannelSplit/ChannelSplit.h [4.2] *
*
*  NAME
*    ChannelSplit.h
*  COPYRIGHT
*    $VER: ChannelSplit.h 4.2 (06.03.03) © by Stefan Kost 1998-2003
*  FUNCTION
*    ChannelSplit core header file
*  AUTHOR
...
#ifndef  CHANNELSPLIT_H
#define  CHANNELSPLIT_H
...
//-- prototypes ---------------------------------------------------------------
	...
	extern void process_s2m(SFXCoreInstance *instance,unsigned long samples);
	extern void process_q2s(SFXCoreInstance *instance,unsigned long samples);
