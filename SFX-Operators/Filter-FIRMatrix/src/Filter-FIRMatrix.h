/****h* Filter-FIRMatrix/Filter-FIRMatrix.h [4.2] *
*
*  NAME
*    Filter-FIRMatrix.h
*  COPYRIGHT
*    $VER: Filter-FIRMatrix.h 4.2 (06.03.03) © by Stefan Kost 1998-2003
*  FUNCTION
*    Filter-FIRMatrix core header file
*  AUTHOR
...
#ifndef  FILTER_FIRMATRIX_H
#define  FILTER_FIRMATRIX_H
...
#define SFXCoreInstanceFields \
	...
	Param					p_amps;\
	Param					p_ampe;\
	double					p_matrix[64];/* Convolutionsmatrix */\
	\
