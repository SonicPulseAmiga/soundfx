/****h* Filter-FIRBandStop/Filter-FIRBandStop.h [4.2] *
*
*  NAME
*    Filter-FIRBandStop.h
*  COPYRIGHT
*    $VER: Filter-FIRBandStop.h 4.2 (06.03.03) © by Stefan Kost 1998-2003
*  FUNCTION
*    Filter-FIRBandStop core header file
*  AUTHOR
...
#ifndef  FILTER_FIRBANDSTOP_H
#define  FILTER_FIRBANDSTOP_H
