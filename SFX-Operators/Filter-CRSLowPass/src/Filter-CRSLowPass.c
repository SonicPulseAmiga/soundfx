/****h* Filter-CRSLowPass/Filter-CRSLowPass.c [4.2] *
*
*  NAME
*    Filter-CRSLowPass.c
*  COPYRIGHT
*    $VER: Filter-CRSLowPass.c 4.2 (11.03.03) © by Stefan Kost 1998-2003
*  FUNCTION
*    Filter-CRSLowPass core file
*  AUTHOR
...
*******
*/
/****u* _operators/Filter-CRSLowPass *
*  Function.eng
